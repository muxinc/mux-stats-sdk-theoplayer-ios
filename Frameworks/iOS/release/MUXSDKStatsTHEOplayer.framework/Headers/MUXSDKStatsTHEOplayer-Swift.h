...
///
+ (void)monitorTHEOplayer:(THEOplayer * _Nonnull)player name:(NSString * _Nonnull)name playerData:(MUXSDKCustomerPlayerData * _Nonnull)playerData videoData:(MUXSDKCustomerVideoData * _Nonnull)videoData;
