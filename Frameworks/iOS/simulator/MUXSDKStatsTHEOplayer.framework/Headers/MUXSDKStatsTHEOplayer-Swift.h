...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MUXSDKStatsTHEOplayer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21MUXSDKStatsTHEOplayer21MUXSDKStatsTHEOplayer")
@interface MUXSDKStatsTHEOplayer : NSObject
...
/// \param _ A player object to monitor
///
...
///
+ (void)monitorTHEOplayer:(THEOplayer * _Nonnull)player name:(NSString * _Nonnull)name playerData:(MUXSDKCustomerPlayerData * _Nonnull)playerData videoData:(MUXSDKCustomerVideoData * _Nonnull)videoData softwareVersion:(NSString * _Nullable)softwareVersion;
...
/// \param videoData A MUXSDKCustomerVideoData object with video metadata 
///
+ (void)videoChangeForPlayerWithName:(NSString * _Nonnull)name videoData:(MUXSDKCustomerVideoData * _Nonnull)videoData;
...
/// \param name The name of the player to destroy
///
